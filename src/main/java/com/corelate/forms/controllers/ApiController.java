...
public class ApiController {
    ...
    @Operation(
            ...
            description = "Get Build information that is deployed into orchestrator microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java versions details that is installed into orchestrator microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
